...
const Slider = () => {
  ...
  return (
    <div className='h-full w-full flex items-center relative'>
      ...
      >
        {imageList.map((image, index) => (
          <SwiperSlide key={index} className='h-full w-full flex items-center justify-center'>
            <div className='flex items-center bg-re w-full  h-full justify-center'>
              <img src={image} alt='' className='w-[70%] h-[70%]  rounded-xl object-fit' />
            </div>
          </SwiperSlide>
        ))}
      </Swiper>
      ...
      {/* Like & Share Buttons */}
      <div className='absolute top-[3vw] right-2 z-10 flex flex-col gap-2'>
