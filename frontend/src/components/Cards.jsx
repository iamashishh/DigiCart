    ...
    products.map((p) => (
      ...
      >
        ...
        <div className="flex flex-col gap-1 items-start w-full px-2">
          ...
          <p className="text-sm text-[#7D7C7C] hidden sm:hidden md:hidden lg:block ">
          ...
          <button className="text-[#454443FF] text-sm border px-2 py-1 mt-2 border-[#454443FF] rounded-2xl hover:bg-[#003C26FF] hover:text-[#B8D7CDFF] transition">
            Add to Cart
          </button>
        </div>
      </Link>
