  ...
  return (
    <div className="min-h-screen flex items-center justify-center  lg:px-4  md:px-8 ">
      <div className="relative">
        ...
        <div className="bg-white lg:p-8  max-sm:p-2 max-md:p-6    p-2 flex flex-col justify-center md:absolute md:w-[25vw] md:h-[70vh] md:top-9 md:-left-40 md:rounded-xl rounded-t-xl shadow-2xl">
          ...
          <form className="lg:mt-5 max-sm:mt-3 max-md:mt-5 " onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
              <div className="lg:mb-4 max-md:mb-4 max-sm:mb-2">
                <label
                  htmlFor="username"
            ...
            <div className="lg:mb-4 max-md:mb-4 max-sm:mb-4">
              <label
                htmlFor="role"
                className="font-semibold text-lg text-[#046664] px-1"
              >
            ...
            <button
              type="submit"
              className="w-full bg-[#046664] hover:opacity-90 font-semibold text-white py-3 rounded-lg lg:mb-2 "
              disabled={loading}
            >
        ...
        <div className="bg-[url('./bg.jpeg')] flex flex-col items-center justify-center bg-cover bg-top text-white lg:p-8 max-sm:p-4 max-md:p-4 w-full md:w-[30vw] md:h-[80vh] md:ml-[40%] md:rounded-xl rounded-b-xl shadow-2xl">
          <div className="text-center">
            ...
            <p className="md:mt-4 lg:mt-2 lg:mb-8 max-sm:mb-4 max-md:mb-6 text-lg font-semibold md:px-6">
