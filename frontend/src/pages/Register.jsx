                ...
                <div className="bg-white p-8 flex flex-col justify-center md:absolute md:w-[25vw] md:h-[70vh] md:top-9 md:-left-40 md:rounded-xl rounded-t-xl shadow-2xl">
                    ...
                    <form className="mt-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
                            <div className="mb-4">
                                <label htmlFor="First Name" className="font-semibold text-lg text-[#046664] px-1">First Name</label>
                                <input
                                    onChange={(e)=>{
                            ...
                            <div className="mb-4">
                                <label htmlFor="Last Name" className="font-semibold text-lg text-[#046664] px-1">Last Name</label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="Email" className="font-semibold text-lg text-[#046664] px-1">Email</label>
                            <input
                                onChange={(e)=>{
                        ...
                        <div className="mb-4">
                            <label htmlFor="Password" className="font-semibold text-lg text-[#046664] px-1">Password</label>
                            <input
                                onChange={(e)=>{
